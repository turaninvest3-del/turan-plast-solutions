      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-4 md:grid-cols-[1.1fr_1fr] md:items-center md:px-6">
        <Reveal>
          ...
          <p className="mt-5 text-muted-foreground md:text-lg">
            ...
            100% пищевого HDPE. Выпускаем только прозрачные пакеты без печати
            принтов: <b>майка</b> (с ручками) для кассы и{" "}
            <b>фасовка</b> (без ручек) для расфасовки товара, а также готовые
            упакованные позиции на полку.
          </p>
...
const PRODUCTS_STORE: Product[] = [
  { name: "Майка-бомба", size: "25 × 43 см", qty: "300 шт/рул.", purpose: "На кассу" },
...
function WhyUs() {
  const items = [
    ...
    { icon: Users, title: "Сети и небольшие точки", text: "Уже работаем с Magnum, Toimart, Galmart — и с магазинами у дома." },
...
function Faq() {
  const items = [
    ...
    { q: "Работаете с сетевыми магазинами и дистрибьюторами?", a: "Да. Среди клиентов — Magnum, Toimart, Galmart. Работаем и с несетевой розницей, и с оптовыми покупателями." },
  ];
  return (
    <section className="py-16 md:py-24">
