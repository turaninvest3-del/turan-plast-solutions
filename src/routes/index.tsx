...
const PRODUCTS_STORE: Product[] = [
  ...
  { name: "Фасовка 500", size: "уточняется", qty: "500 шт/уп.", purpose: "Расфасовка ", price: "1000 тг" },
  { name: "Мини-майка", size: "20 × 34 см", qty: "180 шт/рул.", purpose: "На кассу", price: "550 тг" },
